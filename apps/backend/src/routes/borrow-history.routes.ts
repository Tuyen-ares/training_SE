...
router.get('/activity/me', requireAuth, requirePermission('borrow_history.view_own'), controller.ownActivity);
router.get('/activity', requireAuth, requirePermission('borrow_history.view_all'), controller.allActivity);
...
router.get('/return-queue/:requestId', requireAuth, requirePermission('asset.checkin'), controller.returnDetail);
