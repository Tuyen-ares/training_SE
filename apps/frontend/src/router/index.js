...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/register',
      name: 'register',
      component: () => import('../views/auth/RegistrationRequestCreateView.vue'),
      meta: { guestOnly: true },
    },
    {
      path: '/main',
    ...
    },
    {
      ...
      component: () => import('../views/borrowing/BorrowRequestCreateView.vue'),
      meta: { requiresAuth: true, permission: 'borrow_request.create' },
    },
    {
      path: '/borrow-requests',
      name: 'my-requests',
      component: () => import('../views/borrowing/MyBorrowRequestsView.vue'),
      meta: { requiresAuth: true, permission: 'borrow_request.view_own' },
    },
    {
      path: '/borrow-requests/:id',
      name: 'borrow-request-detail',
      component: () => import('../views/borrowing/BorrowRequestDetailView.vue'),
      meta: { requiresAuth: true, permission: 'borrow_request.view_own' },
    },
    {
      path: '/approval-queue',
      name: 'approval-queue',
      component: () => import('../views/borrowing/ApprovalQueueView.vue'),
      meta: { requiresAuth: true, permission: 'borrow_request.view_all' },
    },
    {
      path: '/approval-queue/:id',
      name: 'approval-detail',
      component: () => import('../views/borrowing/ApprovalDetailView.vue'),
      meta: { requiresAuth: true, permission: 'borrow_request.view_all' },
    },
    {
      path: '/handover-return',
      name: 'handover-return',
      component: () => import('../views/borrowing/HandoverReturnView.vue'),
    ...
    },
    {
      ...
      component: () => import('../views/administration/registration-requests/RegistrationRequestListView.vue'),
      meta: { requiresAuth: true, permission: 'user_registration.review' },
    },
    {
      path: '/registration-requests/:id',
      name: 'registration-request-detail',
      component: () => import('../views/administration/registration-requests/RegistrationRequestDetailView.vue'),
      meta: { requiresAuth: true, permission: 'user_registration.review' },
    },
    {
      path: '/roles',
      name: 'roles',
      component: () => import('../views/administration/roles/RoleListView.vue'),
      meta: { requiresAuth: true, permissionsAny: ['role.view', 'role.assign', 'user_registration.review'] },
    },
    {
      path: '/roles/new',
      name: 'role-create',
      component: () => import('../views/administration/roles/RoleFormView.vue'),
    ...
    },
    {
      path: '/departments',
      name: 'departments',
      component: () => import('../views/administration/departments/DepartmentListView.vue'),
    ...
    },
    {
      ...
      component: () => import('../views/borrowing/BorrowingActivityDetailView.vue'),
      meta: { requiresAuth: true, permissionsAny: ['borrow_history.view_own', 'borrow_history.view_all'] },
    },
    {
      path: '/asset-catalog',
    ...
    },
    {
      path: '/asset-issues',
      name: 'asset-issues',
      component: () => import('../views/asset-issues/AssetIssueListView.vue'),
      meta: { requiresAuth: true, permission: 'asset_issue.view' },
    },
    {
      path: '/asset-issues/:id',
      name: 'asset-issue-detail',
      component: () => import('../views/asset-issues/AssetIssueDetailView.vue'),
      meta: { requiresAuth: true, permission: 'asset_issue.view' },
    },
    {
      path: '/vendors',
