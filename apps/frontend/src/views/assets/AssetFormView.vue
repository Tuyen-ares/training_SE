...
<style scoped>
.asset-form-page { margin: 0 auto; max-width: 920px; padding: 24px 16px 40px; }.asset-form-heading{margin:20px 0 14px}.asset-form-heading :deep(.ant-typography){margin-bottom:4px}.asset-form-panel { background: var(--ant-color-bg-container); border: 1px solid var(--ant-color-border-secondary); border-radius: 8px; padding: 24px; }.asset-form-panel h3{border-bottom:1px solid #f0f0f0;padding-bottom:14px}.asset-form-panel :deep(.ant-form) { max-width: 760px; }.initial-status{display:grid;gap:6px;margin-bottom:18px}.initial-status>span{font-weight:600}.initial-status :deep(.ant-tag){justify-self:start}.initial-status small{color:#8c8c8c}.form-actions{display:flex;justify-content:flex-end;margin-top:22px}@media (max-width: 640px) { .asset-form-page { padding: 16px 12px 32px; }.asset-form-panel { padding: 16px; } }
</style>
